...
# These words usually do not help much in ranking because they appear everywhere.
STOPWORDS = {
    "a",
    "an",
    "and",
...
def tokenize(text: str, *, remove_stopwords: bool = True) -> list[str]:
    """Turn text into normalized v1 tokens."""
...
def join_tokens(tokens: Iterable[str]) -> str:
    """Join analyzer tokens back into a passage string."""
    return " ".join(tokens)
